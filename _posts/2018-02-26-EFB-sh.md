---
title: Telegram 机器人 -- 迁移 wechat 到 Telegram 之操作详解
date: 2018-02-26
layout: post
comments: true
share: true
description: CentOS6.5 搭建 EhForwarderBot v1.0 完全攻略
tags:
 - 教程
 - Telegram
---

![](https://ws2.sinaimg.cn/large/78905b2cgy1fpn486zifaj20ud0ibjyl.jpg){:.center-image}

* TOC
{:toc}

> 本教程基于搬瓦工 VPS CentOS6 x86_64 环境测试成功。
{:.note}
...
V2.0 版本更新了一个 facebook 从端，同时支持多从端同时运行，降低了不同从端相互干扰的概率，配置方式也发生了改变，支持 pip3 和 git clone 方式安装使用。由于尚未亲测，所以留个坑。放一篇 Ubuntu 下配置使用 EFB v2.0 的[脚本](https://paste.ubuntu.com/p/VvDZxQ5k8k/)。
